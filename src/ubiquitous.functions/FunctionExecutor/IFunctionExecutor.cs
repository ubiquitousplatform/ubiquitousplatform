...
/// <summary>
/// This is a thin wrapper around the underlying execution engine that abstracts out the steps of the lifecycle of a piece of code.
...
/// Host functions that need to be patched into the execution context are "plugged in" via a registration call to RegisterHostFunction.
/// </summary>
